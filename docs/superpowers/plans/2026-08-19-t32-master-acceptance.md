...
| 4 | `PARTIAL`: hygiene tooling, personal-use signing and reports passed; public release inputs remain fail-closed | `BLOCKED`: complete license closure, tag, reproducibility, publisher identity and release device are absent | `docs/qa/t32-release-compliance-report.md`, `docs/release/release-gate-result.json`, `T32-PERSONAL-RELEASE-20260820` |
